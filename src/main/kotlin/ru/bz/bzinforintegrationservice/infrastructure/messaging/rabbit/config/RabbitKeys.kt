...
object RabbitKeys {
    ...
    const val FIND_LOCATIONS_OF_MEASURED_REMAINDERS_QUEUE ="find_locations_of_measured_remainders"
    const val FIND_MATERIALS_OF_MEASURED_REMAINDERS_QUEUE ="find_materials_of_measured_remainders"
    const val FIND_PROJECT_CODES_OF_MEASURED_REMAINDERS_QUEUE ="find_project_codes_of_measured_remainders"
    const val FIND_WAREHOUSE_CODES_OF_MEASURED_REMAINDERS_QUEUE ="find_warehouse_codes_of_measured_remainders"
    ...
    const val FIND_LOCATIONS_OF_MEASURED_REMAINDERS_KEY ="find_locations_of_measured_remainders"
    const val FIND_MATERIALS_OF_MEASURED_REMAINDERS_KEY ="find_materials_of_measured_remainders"
    const val FIND_PROJECT_CODES_OF_MEASURED_REMAINDERS_KEY ="find_project_codes_of_measured_remainders"
    const val FIND_WAREHOUSE_CODES_OF_MEASURED_REMAINDERS_KEY ="find_warehouse_codes_of_measured_remainders"
